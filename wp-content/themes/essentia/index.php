...
<div class="home">
  ...
  <section class="bannerHome">
    <figure class="bannerHome-image">
      <?php
      $image = $banner['image'];
      if ($image): ?><img src="<?= $image['url'] ?>" alt="<?= $image[
  'title'
] ?>"><?php endif;
      ?>
    </figure>
  ...
  <section class="sustainabilityHome">
    <div class="container">
      <div class="sustainabilityHome-content">
        <h2 class="sustainabilityHome-title"><?= $sustainability[
          'title'
        ] ?></h2>
      ...
      ?>
      <?php
      $sustainability_bg = $sustainability['bg_image'];
...
<?php
query_posts('pagename=nossos-projetos');
if (have_posts()): ?>
